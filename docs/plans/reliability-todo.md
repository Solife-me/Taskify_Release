...
Document the public HTTP contract in [docs/reference/worker-backend.md](../reference/worker-backend.md).
...
- ✅ **Pass 5 — Shared lib + nip05**: shared Worker bindings/helpers and NIP-05 were extracted. The temporary R2 cloud-backup module created during this pass was removed in July 2026 after encrypted Nostr backup became authoritative.
  ...
  2. **[worker/src/nip05.ts](../../worker/src/nip05.ts)** — `parseNip05Address`, `handleNip05Lookup`, the cache-timestamp helper, and NIP-05 cache policy.
