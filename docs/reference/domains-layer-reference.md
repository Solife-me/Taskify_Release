...
This complements:
- `docs/reference/architecture-overview.md` (system-level architecture)
- `docs/reference/functions-and-flows.md` (end-to-end flows)
...
- Worker cron-delivery pipeline (documented in `docs/reference/worker-backend.md`)
...
- Update this file (`docs/reference/domains-layer-reference.md`) if responsibilities or file map changed.
- Update `docs/reference/functions-and-flows.md` if runtime flow order changed.
- Update `docs/reference/architecture-overview.md` if system boundaries changed.
