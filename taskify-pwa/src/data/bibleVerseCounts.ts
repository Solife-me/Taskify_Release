export type BibleVerseCountMap = Record<string, number[]>;

export const BIBLE_VERSE_COUNTS: BibleVerseCountMap = {
  'gen': [31, 25, 24, 26, 32, 22, 24, 22, 29, 32, 32, 20, 18, 24, 21, 16, 27, 33, 38, 18, 34, 24, 20, 67, 34, 35, 46, 22, 35, 43, 55, 32, 20, 31, 29, 43, 36, 30, 23, 23, 57, 38, 34, 34, 28, 34, 31, 22, 33, 26],
  'exo': [22, 25, 22, 31, 23, 30, 29, 28, 35, 29, 10, 51, 22, 31, 27, 36, 16, 27, 25, 26, 36, 31, 33, 18, 40, 37, 21, 43, 46, 38, 18, 35, 23, 35, 35, 38, 29, 31, 43, 38],
  'lev': [17, 16, 17, 35, 19, 30, 38, 36, 24, 20, 47, 8, 59, 57, 33, 34, 16, 30, 37, 27, 24, 33, 44, 23, 55, 46, 34],
  'num': [54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 16, 33, 45, 41, 50, 13, 32, 22, 29, 35, 41, 30, 25, 19, 65, 23, 31, 40, 16, 54, 42, 56, 29, 34, 13],
  ...
  'rut': [22, 23, 18, 22],
  '1sa': [28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24, 42, 15, 23, 28, 23, 44, 25, 12, 25, 11, 31, 13],
  ...
  '2ki': [18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 20, 21, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30],
...
export function getBibleChapterVerseCount(bookId: string, chapter: number): number | undefined {
  const chapters = BIBLE_VERSE_COUNTS[bookId];
  if (!chapters) return undefined;
  const index = Math.trunc(chapter) - 1;
  if (index < 0 || index >= chapters.length) return undefined;
  return chapters[index];
}

export const MAX_VERSES_IN_ANY_CHAPTER = Object.values(BIBLE_VERSE_COUNTS)
  .flat()
